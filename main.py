from src.polytruth.core import And, Not, Or, Var
from src.polytruth.operator import MultiValuedOperators
from src.polytruth import LogicSystem
import numpy as np

from src.polytruth.parser import parse_file
...
def main():
    ...
    logic_system.add_rule("banana",~a&(b|a))
